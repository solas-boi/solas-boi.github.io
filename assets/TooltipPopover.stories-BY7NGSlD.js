import{j as e}from"./jsx-runtime-BjG_zV1W.js";import{$ as I}from"./Button-Ba645Us2.js";import{T as o}from"./TooltipPopover-BTdKxS94.js";import{I as j,c as A}from"./InlineTooltipIconButton-CCKIzqKT.js";import{T as b}from"./Typography-CP2JGh9q.js";import{L as w}from"./Link-k2SR1BJD.js";function B({children:t}){return e.jsx("div",{style:{display:"grid",placeItems:"center",width:"100%",height:350},children:t})}const C={title:"Components/Data Display/TooltipPopover",component:o,decorators:[t=>e.jsx(B,{children:e.jsx(t,{})})],render:function(r){const{children:i,...p}=r;return e.jsx(o,{...p,children:e.jsxs(o.Trigger,{children:[e.jsx(A,{"aria-label":"Button label"}),e.jsx(o.Content,{children:i})]})})},args:{children:`APR stands for Annual Percentage Rate. It's the rate you will have
...
}`,...(m=(g=a.parameters)==null?void 0:g.docs)==null?void 0:m.source}}};var f,P,y;s.parameters={...s.parameters,docs:{...(f=s.parameters)==null?void 0:f.docs,source:{originalSource:`{
  render: function Render(args) {
...
}`,...(y=(P=s.parameters)==null?void 0:P.docs)==null?void 0:y.source}}};var T,v,R;l.parameters={...l.parameters,docs:{...(T=l.parameters)==null?void 0:T.docs,source:{originalSource:`{
  render: function Render(args) {
