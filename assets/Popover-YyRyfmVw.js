import{j as n}from"./jsx-runtime-Blucd9Qg.js";import{u as s,p as a,y as i}from"./index-Z8nU1pHX.js";import{C as p}from"./index-CRAeHTmb.js";import{$ as h,f as $}from"./Dialog-B6YltjvA.js";import{u as m}from"./OverlayContext-BmgfW47V.js";const f=i(p)`
  ${()=>{const{tokens:e}=s(),{select:o}=e;return a`
    ...
    `}}
`;function H(){return n.jsx(f,{"aria-hidden":"true"})}const x=i(h)`
  ${({$width:e})=>{const{tokens:{select:o,scrollBar:{thumbColor:t,trackColor:r}}}=s();return[a`
      ...
      `,e&&a`
          width: ${e}px;
        `]}}
`,I=6,g=2,T=48,v=T*I,w=g+v;function y(e){const{width:o,isOpen:t,onOpenChange:r,triggerRef:d,...l}=e,{tokens:u}=s(),{select:b}=u,{portalElement:c}=m();return n.jsx($,{getContainer:c&&(()=>c),children:n.jsx(x,{$width:o,maxHeight:w,offset:parseInt(b.gap,10),isOpen:t,onOpenChange:r,triggerRef:d,...l})})}export{H as C,w as M,y as P};
