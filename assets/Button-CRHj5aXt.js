import{j as s}from"./jsx-runtime-Blucd9Qg.js";import{r as f}from"./index-CcKhGcwW.js";import{B as u}from"./index-DfrVGm6s.js";import{u as i,p as b}from"./index-CgLgilxD.js";import{i as d,u as n}from"./styled-components.browser.esm-hO7_nGqz.js";import{$ as L}from"./Button-c0q88Mvj.js";import{T as m}from"./Typography-SwM_NNf7.js";import{S as k}from"./Spinner-BJw-yL-S.js";const r=n(L)`
...
`,j=n.div`
  ...
  display: grid;
  place-items: center;
`,Y=f.forwardRef((t,a)=>{const{variant:o=u.DEFAULT_VARIANT,startIcon:e,fullWidth:y,children:g,testID:c="button",...l}=t,{isPending:h}=l,{tokens:$}=i(),{button:p}=$;return s.jsxs(r,{...l,ref:a,$variant:o,$fullWidth:y,"data-testid":c,children:[s.jsx(w,{$variant:o}),s.jsx(x,{$variant:o,children:s.jsxs(v,{children:[e&&s.jsx(C,{children:e}),s.jsx(R,{children:s.jsx(m,{variant:p.topLayer.text.typography.variant,fontFamily:p.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:g})}),h&&s.jsx(j,{children:s.jsx(k,{"aria-label":"Loading...",variant:u.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})]})});Y.displayName="Button";export{Y as B};
