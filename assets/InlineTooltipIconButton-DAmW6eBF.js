import{i as e,u as i}from"./styled-components.browser.esm-hO7_nGqz.js";import{$ as y,a as u}from"./Tooltip-BEBQ_rTE.js";import{u as s,p as b}from"./index-CgLgilxD.js";import{T as x}from"./Typography-SwM_NNf7.js";import{a as v,b as g,T as I}from"./index-DfrVGm6s.js";import{j as a}from"./jsx-runtime-Blucd9Qg.js";import{b as T,c as k}from"./Dialog-Ccph-4LA.js";import{r as l}from"./index-CcKhGcwW.js";import{$ as C}from"./Button-c0q88Mvj.js";import{I as w,a as B}from"./index-CRAeHTmb.js";const q=i(y)`
...
`,J=i(x)`
  ${()=>{const{tokens:t}=s(),{scrollBar:n}=t;return e`
    ...
    `}}
`,K=v.DEFAULT_OFFSET,Q="top",F=i(T)`
  ${()=>{const{tokens:t}=s(),{tooltip:n}=t;return e`
      svg {
        display: block;
    ...
    `}}
`;function X(){const{tokens:t}=s(),{tooltip:n}=t,o=parseInt(n.arrow.height),r=parseInt(n.arrow.width);return a.jsx(F,{style:{width:r,height:o},children:a.jsx("svg",{"aria-hidden":!0,width:r,height:o,viewBox:`0 0 ${r} ${o}`,children:a.jsx("path",{d:`M0 0 L${o} ${o} L${r} 0`})})})}const j=i.span`
