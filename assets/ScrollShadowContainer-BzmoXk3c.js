...
`,T=h(P)`
  ${({$viewportWidth:o,$tabletWidth:e})=>{const{tokens:t}=w(),{modal:n}=t,i=o-parseInt(n.padding.tablet,10)*2;return f`
    ...
    `}}
`,z=a.forwardRef((o,e)=>{const{width:t}=D();return c.jsx(T,{...o,ref:e,$viewportWidth:t})});function A(o,e){a.useEffect(()=>{const t=o.current;t&&(e&&!t.open?(t.showModal(),t.focus()):!e&&t.open&&t.close())},[e])}function B(o,e){a.useEffect(()=>{const t=o.current;function n(i){i.key==="Escape"&&(i.preventDefault(),e==null||e())}if(t)return t.addEventListener("keydown",n),()=>{t.removeEventListener("keydown",n)}},[e])}function E(){return"ontouchstart"in window||navigator.maxTouchPoints>0}function oe(o){const{isOpen:e,onRequestClose:t,children:n,testID:i="modal",tabletWidth:l,...u}=o,r=a.useRef(null),d=a.useRef(null),[m,j]=a.useState();function y(p){p&&j(p)}A(r,e),B(r,t),a.useEffect(()=>{if(!e||E())return;const p=requestAnimationFrame(()=>{const b=r.current,x=d.current;b&&document.activeElement===b?(b.querySelector('button, [href], input, select, textarea, [tabindex]:not([tabindex="-1"])')??x??b).focus():x&&!(b!=null&&b.contains(document.activeElement))&&x.focus()});return()=>cancelAnimationFrame(p)},[e]);const R=p=>{p.stopPropagation()};L({isDisabled:!e});let $=c.jsx(F,{...u,ref:r,closedby:"none","aria-modal":!0,tabIndex:-1,"data-testid":i,onClick:t,children:c.jsxs(z,{ref:d,tabIndex:-1,onClick:R,$tabletWidth:l,children:[n,c.jsx("div",{ref:y})]})});return E()||($=c.jsx(I,{contain:e,restoreFocus:!0,children:$})),c.jsx(V,{portalElement:m,children:$})}const O=h.div`
  position: relative;
  height: 100%;
  overflow: hidden;
`,k=h.div`
...
`,K=h.div`
  ${()=>{const{tokens:{scrollShadowContainer:o,scrollBar:{thumbColor:e,trackColor:t}}}=w();return f`
    ...
    `}}
`;function G(o){const e=a.useRef(null),t=a.useRef(null),[n,i]=a.useState(!1),[l,u]=a.useState(!1);return a.useEffect(()=>{o==null||o({topShadowVisible:n,bottomShadowVisible:l})},[o,n,l]),a.useEffect(()=>{if(!e.current||!t.current)return;const r=new IntersectionObserver(([m])=>{m&&i(!m.isIntersecting)}),d=new IntersectionObserver(([m])=>{m&&u(!m.isIntersecting)});return r.observe(e.current),d.observe(t.current),()=>{r.disconnect(),d.disconnect()}},[]),{topShadowRef:e,bottomShadowRef:t,topShadowVisible:n,bottomShadowVisible:l}}function ne(o){const{tabIndex:e,onChange:t,children:n}=o,{topShadowRef:i,bottomShadowRef:l,topShadowVisible:u,bottomShadowVisible:r}=G(t);return c.jsxs(O,{children:[c.jsx(M,{$visible:u,"aria-hidden":!0}),c.jsxs(K,{tabIndex:e,children:[c.jsx("div",{ref:i}),n,c.jsx("div",{ref:l})]}),c.jsx(Y,{$visible:r,"aria-hidden":!0})]})}export{P as C,oe as M,ne as S,E as h};
