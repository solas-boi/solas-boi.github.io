import{j as w}from"./index-DfrVGm6s.js";import{S as L}from"./Select-BBWeETO4.js";const _={title:"Components/Inputs/Select",component:L,argTypes:{placeholder:{control:"text"},isDisabled:{control:"boolean"},isRequired:{control:"boolean"},isInvalid:{control:"boolean"}},args:{placeholder:"Select",isDisabled:!1,isRequired:!1,isInvalid:!1,items:w.mockItems}},e={args:{"aria-label":"Select label"}},a={args:{labelProps:{label:"Select label",labelTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},l={args:{labelProps:{label:"Select label",labelHint:"Additional information",labelHintTooltipProps:{iconButtonProps:{"aria-label":"Button label"},contentProps:{children:"APR stands for Annual Percentage Rate. It's the rate you will have to pay for the chosen loan amount."}}}}},r={args:{disabledKeys:["item-02","item-04"],labelProps:{label:"Select label"}}},t={args:{isDisabled:!0,labelProps:{label:"Select label"}}},o={args:{isInvalid:!0,labelProps:{label:"Select label"},alerts:[{severity:"error",children:"Error description over two lines if required."}]}},s={args:{items:w.mockItemsWithAriaLabel,placeholder:"Select",labelProps:{label:"Select with ariaLabel on items"}}};var n,i,c;e.parameters={...e.parameters,docs:{...(n=e.parameters)==null?void 0:n.docs,source:{originalSource:`{
  args: {
...
}`,...(B=(A=o.parameters)==null?void 0:A.docs)==null?void 0:B.source}}};var R,D,W;s.parameters={...s.parameters,docs:{...(R=s.parameters)==null?void 0:R.docs,source:{originalSource:`{
  args: {
