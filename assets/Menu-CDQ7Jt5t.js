import{j as t}from"./jsx-runtime-Blucd9Qg.js";import{r as p}from"./index-CcKhGcwW.js";import{$ as b,d as m,e as x,g as h,f}from"./Dialog-Ccph-4LA.js";import{M as g}from"./index-DfrVGm6s.js";import{i as c,u as a}from"./styled-components.browser.esm-hO7_nGqz.js";import{u as l}from"./index-CgLgilxD.js";import{u as k}from"./ScrollShadow.hooks-yTS4ggiE.js";import{u as M}from"./OverlayContext-BmgfW47V.js";import{$ as I}from"./Pressable-el_FSRkm.js";const T=a(b)`
...
`,w=a.div`
  ${()=>{const{tokens:e}=l(),{menu:o,select:r}=e;return c`
    ...
    `}}
`,O="bottom end",y=6,C=2,E=48,_=E*y,S=C+_,$=p.createContext({}),j=e=>{const{children:o,...r}=e;return t.jsx($.Provider,{value:r,children:o})};function n(e){const{children:o,testID:r="menu",...s}=e;return t.jsx(j,{...s,testID:r,children:t.jsx(h,{children:o})})}n.Trigger=function(o){return t.jsx(I,{...o})};n.Content=function(o){const{children:r}=o,{popoverProps:s,testID:d}=p.useContext($),{portalElement:u}=M();return t.jsx(f,{getContainer:u&&(()=>u),children:t.jsx(T,{offset:g.DEFAULT_OFFSET,maxHeight:S,...s,children:t.jsx(v,{"data-testid":d,children:r})})})};n.Item=function(o){const{children:r,...s}=o;return t.jsx(i,{...s,children:d=>t.jsx(w,{children:typeof r=="function"?r(d):r})})};n.displayName="Menu";n.Trigger.displayName="Menu.Trigger";n.Content.displayName="Menu.Content";n.Item.displayName="Menu.Item";export{O as D,n as M};
