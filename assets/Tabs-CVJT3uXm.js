import{j as a}from"./jsx-runtime-Blucd9Qg.js";import{r as l}from"./index-CcKhGcwW.js";import{r as w}from"./index-CbrIw9sE.js";import{b as L,$ as j,a as I,c as R}from"./Tabs-YapAOstT.js";import{$ as k}from"./SelectionIndicator-GRP_vUUg.js";import{i as s,u as c}from"./styled-components.browser.esm-hO7_nGqz.js";import{u}from"./index-CgLgilxD.js";import{S as C}from"./Select-C8OYF7oV.js";import{T as v}from"./Typography-BYRdA7Ce.js";const D=c.div`
...
`,f=l.createContext({}),E=c.div`
  ${()=>{const{tokens:e}=u(),{tabs:t}=e;return s`
    ...
    `}}
`;function S(){const{items:e,selectedKey:t,onSelectionChange:o,mobileHeading:n}=l.useContext(f),i=l.useMemo(()=>e.map(({id:d,label:r})=>({id:d,value:d,title:r})),[e]),p=l.useMemo(()=>e.filter(({isDisabled:d})=>d).map(({id:d})=>d),[e]);return a.jsx(E,{children:a.jsx(C,{labelProps:{label:n},items:i,selectedKey:t,disabledKeys:p,onSelectionChange:o})})}const M=c.div`
...
`,B=c.div`
  ${()=>{const{tokens:e}=u(),{separator:t}=e.tabs.desktop.tab;return s`
    ...
    `}}
`,N=2;function O(){const{items:e,desktopHeading:t,desktopHeadingLevel:o=N,testID:n}=l.useContext(f),i=G(),{headingID:p,getTabA11yData:d}=U();return a.jsxs(M,{children:[t&&a.jsx(v,{id:p,component:`h${o}`,variant:i.heading.variant,fontFamily:i.heading.fontFamily,testID:`${n}-heading`,children:t}),a.jsx(V,{"aria-labelledby":p,"data-testid":`${n}-items`,children:a.jsx(k,{items:e,children:r=>{const g=!!r.icon,y=r===e.at(-1),{labelID:h,secondaryLabelID:$}=d(r.id);return a.jsxs(b,{id:r.id,isDisabled:r.isDisabled,"aria-labelledby":`${h} ${$}`,"data-testid":`${n}-item-${r.id}`,children:[a.jsxs(H,{children:[a.jsxs(K,{$withIcon:g,children:[a.jsxs("div",{children:[a.jsx(W,{children:a.jsx(v,{id:h,component:"span",variant:i.tab.label.variant,fontFamily:i.tab.label.fontFamily,color:"inherit",children:r.label})}),r.secondaryLabel&&a.jsx(z,{children:a.jsx(v,{id:$,component:"span",variant:i.tab.secondaryLabel.variant,fontFamily:i.tab.secondaryLabel.fontFamily,color:"inherit",children:r.secondaryLabel})})]}),g&&a.jsx(_,{children:r.icon})]}),a.jsx(A,{})]}),!y&&a.jsx(B,{})]})}})})]})}function G(){const{tokens:e}=u(),{heading:t,tab:o}=e.tabs.desktop;return{heading:{variant:t.typography.variant,fontFamily:t.typography.fontFamily},tab:{label:{variant:o.label.typography.variant,fontFamily:o.label.typography.fontFamily},secondaryLabel:{variant:o.secondaryLabel.typography.variant,fontFamily:o.secondaryLabel.typography.fontFamily}}}}function U(){const e=l.useId(),t=`${e}-heading`;function o(n){const i=`${e}-tab-label-${n}`,p=`${e}-tab-secondary-label-${n}`;return{labelID:i,secondaryLabelID:p}}return{headingID:t,getTabA11yData:o}}function x(e){const{activeItemId:t,onChange:o,children:n,testID:i="tabs",...p}=e,[d,r]=l.useState(null),[g,y]=l.useState();function h(m){y(m)}function $(m){m&&o(m)}const T=l.useMemo(()=>({...p,selectedKey:t,onSelectionChange:$,tabListView:d,setTabListView:r,setMobilePortalRef:h,testID:i}),[p,t,$,d,r,h,i]);return a.jsxs(f.Provider,{value:T,children:[a.jsx(R,{selectedKey:t,onSelectionChange:$,"data-testid":i,children:n}),g&&d==="mobile"&&w.createPortal(a.jsx(S,{}),g)]})}x.Items=function(){const{tabListView:t,setTabListView:o,setMobilePortalRef:n}=l.useContext(f),i=l.useRef(null),p=l.useRef(null);return l.useEffect(()=>{if(!i.current||!p.current)return;const d={threshold:1,root:i.current},r=new IntersectionObserver(([g])=>{g&&g.boundingClientRect.height>0&&o(g.isIntersecting?"desktop":"mobile")},d);return r.observe(p.current),()=>{r.disconnect()}},[]),a.jsxs("div",{ref:i,children:[a.jsx(D,{ref:p,$tabListView:t,children:a.jsx(O,{})}),a.jsx("div",{ref:n})]})};x.Panels=function(){const{items:t,withPadding:o=!0,testID:n}=l.useContext(f);return a.jsx(F,{"data-testid":`${n}-panels`,children:a.jsx(k,{items:t,children:i=>a.jsx(P,{id:i.id,$withPadding:o,$withIcon:!!i.icon,"data-testid":`${n}-panel-${i.id}`,children:i.panel})})})};x.displayName="Tabs";export{x as T};
