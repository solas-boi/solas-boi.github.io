import{u as s,p as e,y as i,a as y}from"./index-Z8nU1pHX.js";import{$ as b,a as u}from"./Tooltip-B5VIayZH.js";import{T as x}from"./Typography-DVnGbd4X.js";import{a as v,b as g,T as I}from"./index-eS8l-D1x.js";import{j as a}from"./jsx-runtime-Blucd9Qg.js";import{b as T,c as k}from"./Dialog-B6YltjvA.js";import{r as l}from"./index-CcKhGcwW.js";import{$ as C}from"./Button-rLog8i9z.js";import{I as w,a as B}from"./index-CRAeHTmb.js";const W=i(b)`
...
`,J=v.DEFAULT_OFFSET,K="top",F=i(T)`
  ${()=>{const{tokens:t}=s(),{tooltip:n}=t;return e`
    ...
    `}}
`;function Q(){const{tokens:t}=s(),{tooltip:n}=t,o=parseInt(n.arrow.height),r=parseInt(n.arrow.width);return a.jsx(F,{style:{width:r,height:o},children:a.jsx("svg",{"aria-hidden":!0,width:r,height:o,viewBox:`0 0 ${r} ${o}`,children:a.jsx("path",{d:`M0 0 L${o} ${o} L${r} 0`})})})}const j=i.span`
