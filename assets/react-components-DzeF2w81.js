import{j as n}from"./jsx-runtime-BjG_zV1W.js";import{useMDXComponents as d}from"./index-C77b8QXo.js";import{M as o,e as c}from"./index-C2V8n-Kx.js";import"./index-BlWTxUPR.js";import"./_commonjsHelpers-Cpj98o6Y.js";import"./iframe-CqurxUOW.js";import"./index-BPhdHRfG.js";import"./index-Bhelpi4i.js";import"./index-Bhqu_tAV.js";const s=`# @boi/react-components
...
- 0ee574c: CP-105890: React MultiSelect enhancements
...
- Updated dependencies [7eacfcf]
  ...
  - @boi/js-utils@0.0.25
  - @boi/react-design-tokens@0.0.32
  - @boi/react-icons@0.0.26
  - @boi/react-country-assets@0.0.3
...
- Updated dependencies [7eacfcf]
- Updated dependencies [7eacfcf]
  - @boi/react-design-tokens@0.0.32-next.3
  - @boi/components-core@1.0.4-next.3
  - @boi/react-icons@0.0.26-next.1
  - @boi/react-utils@0.0.21-next.4
  - @boi/js-utils@0.0.25-next.3
  - @boi/react-country-assets@0.0.3-next.0
...
- ba491a0: CP-106695: Fix StandardModal header style
  - @boi/react-design-tokens@0.0.32-next.2
...
- Updated dependencies [76c99bf]
  ...
  - @boi/react-design-tokens@0.0.32-next.1
...
- Updated dependencies [0ee574c]
  ...
  - @boi/react-design-tokens@0.0.32-next.0
  - @boi/react-icons@0.0.26-next.0
...
- 654a4e6: Fix: Restore omitted Combobox props
- 8c597c7: CP-105889 Fix keyboard navigation for the React Select and Combobox components
- 51fd307: CP-104020 Fix Web Modal not announcing dialog role on mobile devices
...
- 47c4170: Chore: Update React Aria URLs in Storybook
- 687b91b: MAT-104961: add to the storybook the aria-label for startSlot directly in the aria-label prop
- 49487d4: CP-105903: Disable React dialog close watcher
- fde48c7: CP-105938: Fix React VoiceOver issue with Combobox items
...
- Updated dependencies [6e7d6a7]
  - @boi/react-design-tokens@0.0.31
...
- Updated dependencies
  - @boi/react-design-tokens@0.0.31-rc.0
...
- Updated dependencies [15fbfa8]
  - @boi/react-design-tokens@0.0.30
  - @boi/fonts@0.0.15
...
- 15fbfa8: Added Davy brand
- Updated dependencies [15fbfa8]
  - @boi/react-design-tokens@0.0.30-rc.0
  - @boi/fonts@0.0.15-rc.0
...
- 079ebe1: [CP-105255] Remove duplicated Modal.styled.ts file
- 468abfa: [CP-105255] Fix web Modal throwing exception on first render due to styled-components recent upgrade
...
- 468abfa: [NOJIRA] Fix web Modal throwing exception on first render due to styled-components recent upgrade

## 2.0.3

### Patch Changes

- 73a0f40: CP-105058: fix ButtonLink style for pressed/down state
- c1e9ab2: CP-94470 Fix CharactersCounter with TalkBack/VoiceOver enabled announcing on first render
- 10df250: CP-99583 Fix Tooltip and TooltipPopover arrow being announced by screen-readers
- 78e0920: CP-104128: Fix Combobox component not annoucing item index on Safari
- b78591d: CP-99578 Fix ToolTip and TooltipPopover arrow being rendered in front of its content
- e738bf0: CP-93714: create a new component called a LinkButton that visually looks like a button, use the Link component instead
- b7093fc: [MAT-59114] updating styled-components
- c36b6e8: CP-104715 TooltipPopover content is now focusable and focus is set to it when the tooltip is opened
- cd21aab: CP-99701: add aria-hidden for start/end slots
- 13f0dd0: CP-103990: create a new component called a ButtonLink that visually looks like a link, use the Button component instead
- Updated dependencies [b7093fc]
- Updated dependencies [c75b283]
- Updated dependencies [45e7371]
  - @boi/react-design-tokens@0.0.29
  - @boi/react-icons@0.0.25
...
- 83ee5d8: CP-104128: upgrade react-aria and react-aria-components
- dca5ec3: CP-104530 Change web StandardModal heading to not render DOM element if heading prop is empty
- 304dcbe: CP-103472: update triggerMenu prop to default "input"
- 09fac74: CP-99368 Allow Tooltip and TooltTip content to scroll
- 9d24cfe: CP-104118 Fix Select component not annoucing item index on Safari
...
- e2da34b: CP-103363 Implement ButtonGroup disabled state visuals
- 307344d: CP-103362 Fix disabled DatePicker having lowercase on the placeholder characters
- 6db922a: CP-103362 add \`isDisabled\` prop to DatePicker components
- 6fb9935: CP-104009: Made the LinkWithIcon right icon positioned vertically in the middle
- 02b006b: CP-102994: Expanded valid options for react-components Link
- f1e22d6: Align Table mock data correctly for docs
- 708db00: CP-98242: Added a workaround for announcing the dialog role on iOS for AlertModal and InformationModal
- 61c2d0a: CP-103509 Set aria-invalid to ButtonGroup component if isInvalid prop is true or if alerts prop have an item with error severity
- Updated dependencies [c6fb6cd]
...
- Updated dependencies [3b1d27f]
  ...
  - @boi/react-design-tokens@0.0.28
  - @boi/js-utils@0.0.22
