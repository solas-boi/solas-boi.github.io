import{j as s}from"./jsx-runtime-BjG_zV1W.js";import{r as f}from"./index-BlWTxUPR.js";import{B as u}from"./index-BDNQ1RZ6.js";import{u as i,i as d,a as n,p as y}from"./index-KUtr2Lc-.js";import{$ as L}from"./Button-Ba645Us2.js";import{T as k}from"./Typography-CP2JGh9q.js";import{S as m}from"./Spinner-CYEq2l28.js";const r=n(L)`
...
`,v=n.div`
  ...
  overflow: hidden;
`,C=n.span`
  ${()=>{const{tokens:t}=i(),{button:a}=t,o=y(a.topLayer.icon.width),e=y(a.topLayer.icon.width);return d`
      display: flex;
      flex-shrink: 0;
...
`,j=n.div`
  ...
  display: grid;
  place-items: center;
`,Y=f.forwardRef((t,a)=>{const{variant:o=u.DEFAULT_VARIANT,startIcon:e,fullWidth:b,children:g,testID:c="button",...l}=t,{isPending:h}=l,{tokens:$}=i(),{button:p}=$;return s.jsxs(r,{...l,ref:a,$variant:o,$fullWidth:b,"data-testid":c,children:[s.jsx(w,{$variant:o}),s.jsx(x,{$variant:o,children:s.jsxs(v,{children:[e&&s.jsx(C,{children:e}),s.jsx(R,{children:s.jsx(k,{variant:p.topLayer.text.typography.variant,fontFamily:p.topLayer.text.typography.fontFamily,noWrap:!0,color:"inherit",component:"div",testID:`${c}-text`,children:g})}),h&&s.jsx(j,{children:s.jsx(m,{"aria-label":"Loading...",variant:u.SPINNER_VARIANTS[o],testID:`${c}-spinner`})})]})})]})});Y.displayName="Button";export{Y as B};
