import{j as i}from"./jsx-runtime-Blucd9Qg.js";import{a as q}from"./index-B-lxVbXh.js";import{n as I,H as B}from"./index-eS8l-D1x.js";import{r as p}from"./index-CcKhGcwW.js";import{u as g}from"./index-CgLgilxD.js";import{b as _}from"./index-CRAeHTmb.js";import{u as l,i as o}from"./styled-components.browser.esm-hO7_nGqz.js";import{C as L,M as D,S as O}from"./ScrollShadowContainer-DHvlPkEv.js";import{I as k}from"./IconButton-D1Ef6OPn.js";import{T as r}from"./Typography-BYRdA7Ce.js";import{B as F}from"./Button-JMOh16Cg.js";const w=l(L)`
  display: grid;
  grid-template-rows: auto 1fr auto;
`,R=l.header`
  ${({$borderVisible:a})=>{const{tokens:t}=g(),{standardModal:e,modal:n}=t;return[o`
        display: grid;
        align-items: center;
      ...
      `,a&&o`
        ...
        `]}}
`,H=l.div`
  ${({$headingVisible:a})=>{const{tokens:{modal:t,standardModal:{header:{padding:e}}}}=g(),n=`calc(${e.mobile.top} + ${e.mobile.bottom} + 100%)`,s=`calc(${e.mobile.top} + ${e.mobile.bottom} + 100%)`;return[o`
        overflow: hidden;
...
`,Q=l.div`
  ...
  margin-bottom: -11px;
`,Y=l.div`
  ${()=>{const{tokens:a}=g(),{standardModal:t,modal:e}=a;return o`
      display: grid;
      gap: ${t.content.gap};
...
}`,...(S=(E=c.parameters)==null?void 0:E.docs)==null?void 0:S.source}}};const J=["Basic","LongContent"],le=Object.freeze(Object.defineProperty({__proto__:null,Basic:m,LongContent:c,__namedExportsOrder:J,default:K},Symbol.toStringTag,{value:"Module"}));export{m as B,c as L,le as S};
