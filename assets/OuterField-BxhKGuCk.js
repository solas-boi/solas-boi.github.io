import{j as i}from"./jsx-runtime-Blucd9Qg.js";import{i as n,u as r}from"./styled-components.browser.esm-hO7_nGqz.js";import{u as l}from"./index-CgLgilxD.js";import{T as a}from"./Typography-BYRdA7Ce.js";const m=r.div`
...
`,u=r.div`
  ${()=>{const{tokens:e}=l(),{outerField:o}=e;return n`
    ...
    `}}
`;function j(e){const{startSlot:o,innerButtonSlot:t,endSlot:c,buttonSlot:d,focusElement:h,isReadOnly:$,children:f}=e;function g(){h()}return i.jsx(m,{children:i.jsxs(p,{onClick:g,$isReadOnly:$,children:[i.jsxs(s,{$buttonSlot:d,children:[o&&i.jsx(k,{"aria-hidden":!0,children:o}),f,t&&i.jsx(v,{children:t}),c&&i.jsx(w,{"aria-hidden":!0,children:c})]}),d&&i.jsx(u,{children:d})]})})}export{j as O};
