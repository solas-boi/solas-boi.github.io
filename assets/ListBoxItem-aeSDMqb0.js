import{j as e}from"./jsx-runtime-Blucd9Qg.js";import{u as r,p}from"./index-CgLgilxD.js";import{i,u as c}from"./styled-components.browser.esm-hO7_nGqz.js";import{$ as h}from"./ListBox-C4lKOGph.js";import{T as g}from"./index-CRAeHTmb.js";import{T as b}from"./Typography-BYRdA7Ce.js";const t=c(h)`
...
`,v=c.div`
  ${()=>{const{tokens:n}=r(),{select:o}=n;return[i`
      ...
      `]}}
`;function L(n){const{icon:o,children:s,isDisabled:l,...u}=n,{tokens:m}=r(),{select:a}=m;return e.jsx(t,{isDisabled:l,...u,children:d=>{const{isSelected:$}=d;return e.jsx(k,{children:e.jsxs(f,{$withIcon:o!==void 0,children:[e.jsx(y,{children:$&&e.jsx(x,{"aria-hidden":"true"})}),o&&e.jsx(v,{children:o}),e.jsx(b,{component:"div",color:"inherit",variant:a.menu.option.inner.text.typography.variant,fontFamily:a.menu.option.inner.text.typography.fontFamily,children:typeof s=="function"?s(d):s})]})})}})}export{L};
