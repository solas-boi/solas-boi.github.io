import{j as r}from"./jsx-runtime-Blucd9Qg.js";import{L as m,B as V}from"./index-eS8l-D1x.js";import{i as y,D as F,L as O}from"./index-CRAeHTmb.js";import{a as $}from"./index-NgCCK6aN.js";import{u,p as a,y as g,a as M}from"./index-SVU_pXp3.js";import{S as W}from"./Spinner-BrD3sMl8.js";import{$ as q}from"./Button-rLog8i9z.js";import{T as G}from"./Typography-Bg4pE1zg.js";const H=g(q)`
...
`,Q=g.div`
  ...
  display: grid;
  place-items: center;
`;function X(t){const{isUnderlined:n=!0,isDashed:o=!1,variant:e=m.DEFAULT_VARIANT,startIcon:h,endIcon:s,children:E,testID:b="button-link",isPending:f,...z}=t,{tokens:C}=u(),{link:P}=C;return r.jsx(H,{...z,isPending:f,"data-testid":b,children:r.jsxs(J,{"data-button-link-container":!0,children:[h&&r.jsx(x,{$isCentered:!0,$variant:e,"data-testid":`${b}-start-icon-wrapper`,children:h}),r.jsx(K,{component:"span",color:"inherit",variant:e,fontFamily:P.typography.fontFamily,$isUnderlined:n,$isDashed:o,children:E}),s&&r.jsx(x,{$isCentered:!0,$variant:e,"data-testid":`${b}-end-icon-wrapper`,children:s}),f&&r.jsx(Q,{children:r.jsx(W,{"aria-label":"Loading...",variant:V.SPINNER_VARIANTS.secondary,testID:`${b}-spinner`})})]})})}const Y={title:"Components/Inputs/ButtonLink",component:X,argTypes:{isDisabled:{control:{type:"boolean"}},isPending:{control:{type:"boolean"}},isUnderlined:{control:{type:"boolean"}},isDashed:{control:{type:"boolean"}},variant:{control:{type:"select"},options:m.VARIANTS},startIcon:{...$(y),if:{arg:"endIcon",truthy:!1}},endIcon:{...$(y),if:{arg:"startIcon",truthy:!1}}},args:{isUnderlined:!0,variant:m.DEFAULT_VARIANT}},i={args:{children:"Text button link label"}},d={argTypes:{isDashed:{control:{disable:!0}}},args:{isDashed:!0,children:"Download report"}},c={argTypes:{isUnderlined:{control:{disable:!0}}},args:{isUnderlined:!1,children:"Download report"}},l={args:{children:"Download report",startIcon:r.jsx(F,{})}},p={args:{children:"Log in",endIcon:r.jsx(O,{})}};var k,I,D;i.parameters={...i.parameters,docs:{...(k=i.parameters)==null?void 0:k.docs,source:{originalSource:`{
  args: {
...
}`,...(N=(B=p.parameters)==null?void 0:B.docs)==null?void 0:N.source}}};const Z=["Basic","Dashed","NoUnderline","StartIcon","EndIcon"],de=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,Dashed:d,EndIcon:p,NoUnderline:c,StartIcon:l,__namedExportsOrder:Z,default:Y},Symbol.toStringTag,{value:"Module"}));export{de as B,d as D,p as E,c as N,l as S,i as a};
