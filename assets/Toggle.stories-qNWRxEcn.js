import{j as r}from"./jsx-runtime-Blucd9Qg.js";import{f as I}from"./index-BQWhUlWo.js";import{m as D}from"./index-DfrVGm6s.js";import{r as O}from"./index-CcKhGcwW.js";import{u as n,p as c}from"./index-CgLgilxD.js";import{u as i,i as g}from"./styled-components.browser.esm-hO7_nGqz.js";import{$ as _}from"./Switch-BxSc5gr8.js";import{T as b}from"./Typography-SwM_NNf7.js";const o=i(_)`
  display: inline-grid;
`,R=i.div`
  ${({$size:t})=>{const{tokens:a}=n(),{toggle:e}=a,s=c(e.size[t].width),d=c(e.size[t].height);return g`
      cursor: pointer;
      width: ${s};
    ...
    `}}
`,W=i.div`
  ${({$size:t})=>{const{tokens:a}=n(),{toggle:e}=a,s=c(e.size[t].width);return g`
      width: ${s};
...
`,E=i.div`
  ${({$size:t})=>{const{tokens:a}=n(),{toggle:e}=a,s=c(e.size[t].width);return[g`
      ...
      `]}}
`,j=t=>{const{tokens:a}=n(),{toggle:e}=a;return`${parseInt(e.thumb.size[t])+parseInt(e.thumb.padding)*3}px`},F=i(b)`
  ${({$size:t})=>{const{tokens:a}=n(),{toggle:e}=a,s=j(t);return[g`
        position: absolute;
        width: 100%;
...
}`,...(z=(w=u.parameters)==null?void 0:w.docs)==null?void 0:z.source}}};const P=["Basic","WithLabel","Disabled"],J=Object.freeze(Object.defineProperty({__proto__:null,Basic:l,Disabled:u,WithLabel:p,__namedExportsOrder:P,default:L},Symbol.toStringTag,{value:"Module"}));export{l as B,u as D,J as T,p as W};
