import{j as i}from"./jsx-runtime-BjG_zV1W.js";import{u as l,i as n,a as r}from"./index-KUtr2Lc-.js";import{T as a}from"./Typography-CP2JGh9q.js";const p=r.div`
...
`,u=r.div`
  ${()=>{const{tokens:e}=l(),{outerField:o}=e;return n`
    ...
    `}}
`;function x(e){const{startSlot:o,endSlot:t,innerButtonSlot:c,buttonSlot:d,focusElement:h,isReadOnly:$,children:g}=e;function f(){h()}return i.jsx(p,{children:i.jsxs(m,{onClick:f,$isReadOnly:$,children:[i.jsxs(s,{$buttonSlot:d,children:[o&&i.jsx(k,{"aria-hidden":!0,children:o}),g,c&&i.jsx(v,{children:c}),t&&i.jsx(w,{"aria-hidden":!0,children:t})]}),d&&i.jsx(u,{children:d})]})})}export{x as O};
