import{j as l}from"./jsx-runtime-Blucd9Qg.js";import{r as g}from"./index-CcKhGcwW.js";import{P as $}from"./index-eS8l-D1x.js";import{u as m}from"./index-CgLgilxD.js";import{i as n,u as p}from"./styled-components.browser.esm-hO7_nGqz.js";import{T as k}from"./Typography-BYRdA7Ce.js";const y=p(k)`
  ${()=>{const{tokens:{progressIndicator:r}}=m();return n`
      color: ${r.label.text.color};
      margin-bottom: ${r.label.marginBottom};
    `}}
`,x=p.div`
  ${()=>{const{tokens:r}=m(),{progressIndicator:e,breakpoint:o}=r;return[n`
        display: flex;
      ...
      `]}}
`,I=p.div`
  ${({$backgroundVariant:r,$isFilled:e,$isFirst:o,$isLast:a})=>{const{tokens:i}=m(),{progressIndicator:d,breakpoint:s}=i,{segment:t}=d.segments;return[n`
        flex: 1;
